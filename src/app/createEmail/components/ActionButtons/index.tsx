...
import { faPaperPlane } from '@fortawesome/free-solid-svg-icons'; // 紙飛行機アイコンをインポート
import { useActionButtons } from '@/app/createEmail/components/ActionButtons/useActionButtons'; // カスタムフックをインポート
import Modal from '@/app/createEmail/components/ActionButtons/Modal'; // モーダルコンポーネントをインポート
